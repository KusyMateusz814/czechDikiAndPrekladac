...
def def_slovnicek_cz(args):
    ...
    prelozitBtn=driver.find_element_by_xpath('/html/body/div/main/div/div[1]/div[2]/form/div/input')
    prelozitBtn.click()
    sleep(1)
    prekladtext=driver.find_element_by_xpath('//*[@id="result_textarea"]')
    slovniktext=driver.find_element_by_xpath('//*[@id="snippet--dictionary"]')
